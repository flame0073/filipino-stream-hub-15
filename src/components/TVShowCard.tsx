    ...
    <Card className="group cursor-pointer hover:scale-105 transition-all duration-300 hover:shadow-lg bg-card border-border overflow-hidden">
      <div className="relative aspect-[2/3] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-all duration-300 flex items-center justify-center">
          <button
            onClick={() => onPlay(show)}
            className="opacity-0 group-hover:opacity-100 bg-primary text-primary-foreground rounded-full p-3 transform scale-75 group-hover:scale-100 transition-all duration-300 hover:bg-primary/90"
          >
